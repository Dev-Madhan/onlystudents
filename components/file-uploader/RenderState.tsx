...
export function RenderEmptyState({isDragActive}: { isDragActive: boolean }) {
    return (
        <div className="text-center">
            ...
            <p className="text-base font-semibold text-foreground">Drop you files or <span
                className="text-primary font-bold cursor-pointer">click to upload</span></p>
...
export function RenderUploadedState({previewUrl, isDeleting, handleRemoveFile}: {
    ...
    return (
        <div>
            ...
            <Button variant="destructive" size="icon" className={cn('absolute top-4 right-4')} onClick={handleRemoveFile} disabled={isDeleting} type="button">
                {isDeleting ? (
...
export function RenderUploadingState({progress, file}: { progress: number, file: File }) {
    return (
        <div className="text-center justify-center items-center flex-col">
            ...
            <p className="mt-2 text-sm font-medium font-serif text-foreground">Uploading...</p>
