      ...
      >
        ...
        <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col items-center justify-center px-4 pt-24 pb-24 md:pt-32 md:pb-32">
          ...
          <motion.h1
            ...
            viewport={{ once: true }}
            className={cn(
              "relative z-10 mx-auto mt-48 max-w-3xl bg-clip-text pb-2 text-center text-5xl leading-[1.15] font-medium tracking-tighter font-serif text-balance text-transparent md:text-[4.2rem]",
              isLight
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className={cn(
              "relative z-10 mx-auto mb-12 max-w-sm bg-clip-text text-center text-[0.8rem] leading-relaxed font-serif text-balance text-transparent sm:max-w-[32rem] sm:text-[0.87rem] lg:text-[1rem]",
              isLight
          ...
          >
            Access top-tier courses and unlock your potential with our platform. Join a community of dedicated learners.
          </motion.p>
          <motion.div
            initial={{
              y: 5,
          ...
          >
            ...
            >
              {/* Get Started */}
              <TextGlitch text="Explore Courses" />
            </Link>
          </motion.div>
        </div>
      </div>
