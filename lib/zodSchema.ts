...
export const courseCategories = ["Programming", "Design", "Business", "It & Software", "Video Editing", "Office productivity", "Personal Development", "Health & Fitness", "Teaching & Academics"] as const;
