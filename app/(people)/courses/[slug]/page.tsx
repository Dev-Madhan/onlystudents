            ...
            <div className="order-1 lg:col-span-2">
                <div className="relative aspect-video w-full overflow-hidden rounded-xl shadow-lg">
                    <Image src={`https://${env.NEXT_PUBLIC_S3_BUCKET_NAME_IMAGES}.t3.storage.dev/${course.fileKey}`}
                           alt="Course Title" fill className="object-cover" priority/>
                ...
                <div className="mt-8 space-y-6">
                    <div className="space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed line-clamp-2 font-serif">{course.smallDescription}</p>
                    </div>
                ...
                <div className="mt-12 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="font-medium font-serif">
                            ...
                            (total, chapter) => total + chapter.lessons.length, 0) || 0}{" "} Lessons
                        </div>
                    </div>

                    <div className="space-y-4">{course.chapters.map((chapter, index) => (
                        <Collapsible key={chapter.id} defaultOpen={index == 0}>
                            <Card
                                className="p-0 overflow-hidden border-2 transition-all duration-200 hover:shadow-md gap-0">
                                <CollapsibleTrigger>
                                    <div>
                                        <CardContent className="p-6 hover:bg-muted/50 transform-colors">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <p className="flex size-10 items-center justify-center rounded-full bg-primary/10 text-primary font-serif font-semibold">{index + 1}</p>
                                                    <div>
                                            ...
                                            {chapter.lessons.map((lesson, lessonIndex) => (
                                                <div key={lesson.id}
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-xs text-muted-foreground font-medium mt-1">Lesson {lessonIndex + 1}</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="mb-6 space-y-3 rounded-lg bg-muted p-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="flex items-center gap-3">
                                        <div
                                            className="flex size-8 items-center justify-center rounded-full bg-primary/10 border-2 border-primary/20">
                                            <IconClock className="size-4"/>
                                        </div>

                                        <div>
                                            <p className="text-sm font-medium">Course Duration</p>
                                            <p className="text-sm text-muted-foreground font-medium">{course.duration} hours</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground font-medium">{course.level}</p>
                                        </div>
                                    </div>
                            ...
                            <p className="mt-3 text-center text-xs font-medium font-serif text-muted-foreground">30-day money-back guarantee</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
