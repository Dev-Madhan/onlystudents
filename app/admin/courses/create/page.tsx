          ...
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (!titleValue) {
                      form.setError("title", {
                        message:
                          "Please enter a title before generating a slug",
                      });
                      return;
                    }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        className="font-medium font-mono text-sm min-h-[120px]"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Demo / Preview Video</FormLabel>
                    <FormControl>
                      <Uploader
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  name="level"
                  render={({ field }) => (
                    <FormItem className="w-full font-medium font-mono">
